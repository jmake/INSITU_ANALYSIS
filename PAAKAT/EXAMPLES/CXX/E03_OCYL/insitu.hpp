...
class InSituCpp 
{
 ...
 ~InSituCpp()
  ...
  void Finalize( )
  {
    ...
    if(rank==0) std::cout<<"[Finalize]\n";
  }


  void Initialize(MPI_Comm handle=MPI_COMM_WORLD, vtkProcessFunctionType process=NULL) 
  {
